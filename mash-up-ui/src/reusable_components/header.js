                ...
                <div className="container">
                    ...
                    <ul className="nav navbar-nav navbar-right">
                        ...
                        {this.props.user.loggedIn?
                            ( <li>
                                <a className="btn btn-primary btn-outline btn-circle" onClick={this.logOutUser.bind(null,this.props.user.email)}>Sign Out</a>
                            </li>)
                        :(
                            <li>
                                <a id="sign-in" className="btn btn-primary btn-outline btn-circle collapsed" onClick={this.toggleLogin}>Sign in</a>
                            </li>
                        )}
                    </ul>
