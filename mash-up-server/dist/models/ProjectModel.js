...
var projectSchema = new mongoose.Schema({
    ...
    members: [{ type: mongoose.Schema.Types.String, ref: 'Member', field: 'memberId' }],
    active: {
        type: Boolean,
        default: false
    },
...
projectSchema.statics.getProject = function (projectId, OrganizationCode) {
    return this.findOne({ "projectId": projectId, "OrganizationCode": OrganizationCode }).populate('member').then(function (data) {
        return data;
    });
};
...
projectSchema.pre('findOne', autoPopulateMember).pre('find', autoPopulateMember);
